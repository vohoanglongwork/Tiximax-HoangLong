...
test('Test tạo tài khoản cskh', async ({ page }) => {
  test.setTimeout(90000);
const randomUsername = `autocskh${Math.random().toString(36).substring(7)}`;
...
function generateRandomEmail() {
  ...
  return `test.cskh_${timestamp}@gmail.com`;
}
...
await page.getByRole('button', { name: 'Chăm sóc khách hàng' }).click();
